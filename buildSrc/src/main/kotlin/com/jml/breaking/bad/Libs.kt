...
object Libs {
    ...
    object UI {
        ...
        const val CONSTRAINT_LAYOUT = "androidx.constraintlayout:constraintlayout:${Versions.UI.CONSTRAINT}"
    ...
    object ViewModel {
        ...
        const val VIEWMODEL_KTX: String ="androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.ViewModel.VIEWMODEL}"
        const val LIFECYCLE_VIEMODEL_KTX = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.ViewModel.LIFE_CYCLE_VIEWMODEL_KTX}"
        const val LIFECYCLE_EXTENSIONS = "androidx.lifecycle:lifecycle-extensions:${Versions.ViewModel.VIEWMODEL}"
        const val LIFECYCLE_COMPILER =  "androidx.lifecycle:lifecycle-compiler:${Versions.ViewModel.VIEWMODEL}"
        const val LIVEDATA_EXT = "androidx.lifecycle:lifecycle-livedata-ktx:${Versions.ViewModel.LIFE_CYCLE_VIEWMODEL_KTX}"
    }
    ...
    object Navigation {
        const val NAVIGATION_FRAGMENT = "androidx.navigation:navigation-fragment:${Versions.AndroidX.NAVIGATION}"
